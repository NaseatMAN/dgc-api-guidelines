...
public sealed class OrderCreatedMessageHandler(IOrderRepository orderService, ILogger<OrderCreatedMessageHandler> logger) : IMessageHandler<OrderCreatedMessage>
{
    private readonly IOrderRepository _orderService = orderService;
